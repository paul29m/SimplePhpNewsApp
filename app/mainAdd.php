...
<title>News App</title>
	...
	<script>	
		function addNews(){
				...
				var posting=$.post(url,{Title:title,Text:text,Producer:producer,Category:category,Date:date},function(data){
					alert(data);
				});
				}
		}
...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"><a href="#">Add News</a></li>
 ...
 <form  id="addForm">
        ...
        <li><input type="button" value="Add" onclick="addNews()" /></li>
 </form>
</body>
</html>
